...
const Footer: React.FC = () => {
    return (
        <footer className="bg-secondary text-black py-6 md:py-10" style={{ height: '70vh' }}>
            <div className="max-w-full flex flex-col justify-between mx-auto px-4 h-full">
                <div className="flex flex-col items-center md:flex-row justify-between mb-6">
                    <div className="flex space-x-4 mb-4 opacity-95 md:mb-0">
                        <a href="https://www.instagram.com/wearecherrypick/" target="_blank" rel="noopener noreferrer" className="footer_social-logo w-inline-block">
                        ...
                        <a href="https://www.facebook.com/wearecherrypick/" target="_blank" rel="noopener noreferrer" className="footer_social-logo w-inline-block">
                        ...
                        <a href="https://twitter.com/wearecherrypick" target="_blank" rel="noopener noreferrer" className="footer_social-logo w-inline-block">
                    ...
                    <div className="flex flex-col text-lg text-primary md:flex-row space-y-2 md:space-y-0 md:space-x-8">
                ...
                <div className="my-2 text-center font-bold text-[10rem] leading-10 tracking-tight text-primary">
                    PettoSpot.
                </div>
